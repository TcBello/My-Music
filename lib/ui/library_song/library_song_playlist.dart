      ...
      builder: (context, song, child) {
        return ListBody(
          children: List.generate(
              song.songInfoFromPlaylist.length, (index) => PlaylistSongTile(
                songInfo: song.songInfoFromPlaylist[index],
                onTap: (){
                  song.setIndex(index);
              ...
              //                                 content: Text(
              //                                     "Are you sure you want to remove ${song.songInfoFromPlaylist[index].title} from this playlist?"),
              //                                 actions: [
              //                                   FlatButton(
              //                                     child: Text(
              //                                       "Cancel",
